...
public class Demo extends JFrame implements JMapViewerEventListener  {
    ...
    public Demo() {
        ...
        JComboBox<?> tileSourceSelector = new JComboBox<Object>(new TileSource[] { new OsmTileSource.Mapnik(),
        ...
        try {
            tileLoaderSelector = new JComboBox<Object>(new TileLoader[] { new OsmFileCacheTileLoader(map()),
                    new OsmTileLoader(map()) });
        } catch (IOException e) {
            tileLoaderSelector = new JComboBox<Object>(new TileLoader[] { new OsmTileLoader(map()) });
        }
